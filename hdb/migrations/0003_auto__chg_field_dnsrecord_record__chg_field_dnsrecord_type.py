...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DNSRecord.record'
        db.alter_column('hdb_dnsrecord', 'record', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True))

        # Changing field 'DNSRecord.type'
        db.alter_column('hdb_dnsrecord', 'type', self.gf('django.db.models.fields.CharField')(max_length=9))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'DNSRecord.record'
        raise RuntimeError("Cannot reverse this migration. 'DNSRecord.record' and its values cannot be restored.")

        # Changing field 'DNSRecord.type'
        db.alter_column('hdb_dnsrecord', 'type', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    models = {
        ...
        'hdb.dnsrecord': {
            ...
            'record': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
