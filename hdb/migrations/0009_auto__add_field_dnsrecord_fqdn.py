...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DNSRecord.fqdn'
        db.add_column('hdb_dnsrecord', 'fqdn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DNSRecord.fqdn'
        db.delete_column('hdb_dnsrecord', 'fqdn')
