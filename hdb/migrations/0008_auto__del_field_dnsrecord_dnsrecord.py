...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DNSRecord.dnsrecord'
        db.delete_column('hdb_dnsrecord', 'dnsrecord_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DNSRecord.dnsrecord'
        db.add_column('hdb_dnsrecord', 'dnsrecord', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child_records', null=True, to=orm['hdb.DNSRecord'], blank=True), keep_default=False)
